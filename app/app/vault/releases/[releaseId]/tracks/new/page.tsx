...
export default async function NewTrackPage({ params }: { params: Promise<{ releaseId: string }> }) {
  ...
  return (
    <div className={styles.grid}>
      <section className={styles.card}>
        <div className={styles.eyebrow}>New track</div>
        ...
        <form action={action} className={styles.form}>
          ...
          <div className={styles.columns2}>
            <div className={styles.field}>
              ...
              <input id="masterFileUrl" name="masterFileUrl" placeholder="https://..." />
            </div>
            <div className={styles.field}>
              <label htmlFor="audioPreviewUrl">Preview URL</label>
              <input id="audioPreviewUrl" name="audioPreviewUrl" placeholder="https://..." />
            </div>
          </div>
          ...
          <InlineAssetUpload
            ...
            title="Upload master audio"
            helpText="Upload the full audio file and the master URL field will be filled in automatically."
          />
          ...
          <InlineAssetUpload
            ...
            title="Upload preview audio"
            helpText="Upload a lighter listening file for reviews, previews, or press kit playback."
          />
